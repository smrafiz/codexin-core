...
class Codexin_Popular_Posts extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			...
			<input type="text" class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" value="<?php echo esc_attr( $title ); ?>" placeholder="<?php echo esc_html__( 'Ex: Popular Posts', 'codexin-core' ) ?>">
		</p>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'display_orderby' ) ); ?>"><?php echo esc_html__( 'Choose The Posts Sorting Method:', 'codexin-core' ); ?></label>
			<select name="<?php echo esc_attr( $this->get_field_name( 'display_orderby' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'display_orderby' ) ); ?>" class="widefat">
				<?php
				$dispby_opt = array(
					__( 'Sort By Views Count', 'codexin-core' ) 		=> 'meta_value_num',
					__( 'Sort By Comments Count', 'codexin-core' ) 	=> 'comment_count',
				);
				foreach ( $dispby_opt as $opt => $value ) {
					echo '<option value="' . esc_attr( $value ) . '" id="' . esc_attr( $value ) . '"', $display_orderby === $value ? ' selected="selected"' : '', '>', esc_html( $opt ), '</option>';
				}
				?>
			</select>
		</p>
	...
	public function widget( $args, $instance ) {
		...
		$posts_args = array(
			...
			'meta_key'				=> ( 'meta_value_num' === $display_orderby ) ? 'cx_post_views' : '',

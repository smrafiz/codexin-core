...
class Codexin_Core {
	...
	public function init() {
		...
		add_action( 'init', array( $this, 'codexin_add_image_sizes' ) );

		// Initialization of photoswipe.
		add_action( 'wp_footer', array( $this, 'codexin_photoswipe_init' ) );
	}
	 ...
	 * @since  1.0
	 */
	public function codexin_add_image_sizes() {
	 ...
	 * @since  1.0
	 */
	public function codexin_photoswipe_init() {
		$result = '';
